...
@app.delete("/eliminarFavoritos/{idFavoritos}")
...
def modificarHerramientas(idHerramientas: str, herramientas: HerramientasInsert):
    ...
    return resultado
@app.delete("/eliminarHerramientas/{idHerramientas}")
